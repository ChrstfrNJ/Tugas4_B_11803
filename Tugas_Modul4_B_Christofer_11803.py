...
def scatter(model, model_name, data, new_point, features, color_scale, title):
    ...
    fig = px.scatter_3d(data, x='Avg_Credit_Limit', y='Total_Credit_Cards', z='Total_visits_online', color=f"{model_name}_Cluster", title=title, color_continuous_scale=color_scale)
...
st.set_page_config(
    page_title="11803 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
